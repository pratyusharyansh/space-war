...
function preload ()
{
  ...
  assitant1img=loadImage("v1.png")
  assitant2img=loadImage("v2.jpg")
  assitant3img=loadImage("v3.jpg")
  assitant4img=loadImage("v4.jpg")
...
if(minialien1G.isTouching(hero)||minialien2G.isTouching(hero)){
  GameState="End"
}
    if(keyDown("SPACE")  ){
      createfirecharge();
...
function spawnAssitant(){
  if (frameCount % 500 === 0){
    var assitant = createSprite(600,165,10,40);
    assitant.velocityX = 1
     ...
     switch(rand) {
       ...
       case 4: assitant.addImage(assitant4img);
               break;
      // case 5: assitant.addImage(obstacle5);
               //break;
       default: break;
     }
  }
